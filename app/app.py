...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', system-ui, -apple-system, sans-serif; }
        ...
        .sidebar { width: 240px; background: #161b22; border-right: 1px solid #30363d; display: flex; flex-direction: column; position: fixed; top: 0; left: 0; height: 100vh; z-index: 100; }
        .sidebar-logo { padding: 20px 24px; border-bottom: 1px solid #30363d; display: flex; align-items: center; gap: 10px; }
        .sidebar-logo span { font-size: 22px; font-weight: 700; color: #1f6feb; letter-spacing: 1px; }
        .sidebar-logo small { font-size: 11px; color: #8b949e; display: block; margin-top: 2px; }
        .sidebar-menu { flex: 1; padding: 12px 0; }
        .sidebar-menu a { display: flex; align-items: center; gap: 12px; padding: 12px 24px; color: #8b949e; text-decoration: none; font-size: 14px; transition: all 0.2s; border-left: 3px solid transparent; }
        .sidebar-menu a:hover, .sidebar-menu a.active { background: #1c2128; color: #e6edf3; border-left-color: #1f6feb; }
        ...
        .navbar { background: #161b22; border-bottom: 1px solid #30363d; padding: 0 32px; height: 64px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 50; }
        .navbar-left { display: flex; align-items: center; gap: 16px; }
        .navbar-left h2 { font-size: 18px; font-weight: 600; color: #e6edf3; }
        ...
        .navbar-right .user-detail .name { font-size: 14px; font-weight: 600; color: #e6edf3; }
        .navbar-right .user-detail .status { font-size: 12px; color: #3fb950; display: flex; align-items: center; gap: 5px; }
        .navbar-right .user-detail .status::before { content: ''; width: 7px; height: 7px; background: #3fb950; border-radius: 50%; display: inline-block; }
        .content { padding: 28px 32px; flex: 1; }
        .metrics { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 28px; }
        .metric-card { background: #161b22; border: 1px solid #30363d; border-radius: 10px; padding: 22px 24px; transition: border-color 0.2s; }
        .metric-card:hover { border-color: #1f6feb; }
        .metric-card .label { font-size: 13px; color: #8b949e; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .metric-card .change.warn { color: #d29922; }
        .metric-card .change.ok { color: #3fb950; }
        .section-title { font-size: 16px; font-weight: 600; color: #e6edf3; margin-bottom: 16px; display: flex; align-items: center; gap: 8px; }
        .section-title .count { font-size: 12px; font-weight: 400; color: #8b949e; background: #21262d; padding: 2px 10px; border-radius: 10px; }
        .table-container { background: #161b22; border: 1px solid #30363d; border-radius: 10px; overflow: hidden; margin-bottom: 28px; }
        table { width: 100%; border-collapse: collapse; }
        thead { background: #1c2128; }
        th { text-align: left; padding: 12px 20px; font-size: 12px; font-weight: 600; color: #8b949e; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid #30363d; }
        td { padding: 14px 20px; font-size: 14px; border-bottom: 1px solid #21262d; }
        tr:last-child td { border-bottom: none; }
        tr:hover td { background: #1c2128; }
        .status-badge { display: inline-block; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; }
        .status-badge.available { background: rgba(63,185,80,0.15); color: #3fb950; }
        .status-badge.low { background: rgba(210,153,34,0.15); color: #d29922; }
        .status-badge.out { background: rgba(248,81,73,0.15); color: #f85149; }
        .panels { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 28px; }
        .panel { background: #161b22; border: 1px solid #30363d; border-radius: 10px; padding: 20px 24px; }
        .panel-title { font-size: 14px; font-weight: 600; color: #e6edf3; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 1px solid #21262d; }
        .movement-item { display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid #21262d; font-size: 13px; }
        .movement-item:last-child { border-bottom: none; }
        .movement-item .date { color: #8b949e; min-width: 85px; }
        .movement-item .prod { flex: 1; color: #e6edf3; padding: 0 12px; }
        .movement-item .qty { font-weight: 600; }
        .movement-item .qty.in { color: #3fb950; }
        .movement-item .qty.out { color: #f85149; }
        .alert-item { display: flex; align-items: flex-start; gap: 12px; padding: 10px 0; border-bottom: 1px solid #21262d; font-size: 13px; }
        .alert-item:last-child { border-bottom: none; }
        .alert-item .icon { font-size: 18px; flex-shrink: 0; margin-top: 1px; }
        .alert-item .icon.warning { color: #d29922; }
        .alert-item .icon.error { color: #f85149; }
        .alert-item .icon.success { color: #3fb950; }
        .alert-item .icon.info { color: #58a6ff; }
        .alert-item .msg { color: #e6edf3; line-height: 1.4; }
        .footer { text-align: center; padding: 20px 32px; border-top: 1px solid #30363d; font-size: 13px; color: #484f58; margin-top: auto; }
